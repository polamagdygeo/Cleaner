...
static u16 Dust_Button_Pressing_Time=20;
...
{
case BUTTON_PLUS:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN1,GPIO_INPUT_DIR);
break;

case BUTTON_MINUS:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN2,GPIO_INPUT_DIR);
break;

case BUTTON_DUST:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN3,GPIO_INPUT_DIR);
break;
}
}
...
ButtonCurrSample=GPIO_GetPinState(GPIO_PORTB,GPIO_PIN1);
...
ButtonCurrSample=GPIO_GetPinState(GPIO_PORTB,GPIO_PIN2);
...
ButtonCurrSample=GPIO_GetPinState(GPIO_PORTB,GPIO_PIN3);
