...
{
case GPIO_PORTA:
(TRISA = (((TRISA)&(~(mask))) | ((dir)&(mask))));
break;
case GPIO_PORTB:
(TRISB = (((TRISB)&(~(mask))) | ((dir)&(mask))));
break;
case GPIO_PORTC:
(TRISC = (((TRISC)&(~(mask))) | ((dir)&(mask))));
break;
case GPIO_PORTD:
(TRISD = (((TRISD)&(~(mask))) | ((dir)&(mask))));
break;
case GPIO_PORTE:
(TRISE = (((TRISE)&(~(mask))) | ((dir)&(mask))));
break;
default:
break;
}
...
{
case GPIO_PORTA:
(TRISA = (((TRISA)&(~(1<<(pin)))) | ((dir)<<(pin))));
break;
case GPIO_PORTB:
(TRISB = (((TRISB)&(~(1<<(pin)))) | ((dir)<<(pin))));
break;
case GPIO_PORTC:
(TRISC = (((TRISC)&(~(1<<(pin)))) | ((dir)<<(pin))));
break;
case GPIO_PORTD:
(TRISD = (((TRISD)&(~(1<<(pin)))) | ((dir)<<(pin))));
break;
case GPIO_PORTE:
(TRISE = (((TRISE)&(~(1<<(pin)))) | ((dir)<<(pin))));
break;
default:
break;
}
...
{
case GPIO_PORTA:
state=(((PORTA) & (1<<(pin))) >> (pin));
break;
case GPIO_PORTB:
state=(((PORTB) & (1<<(pin))) >> (pin));
break;
case GPIO_PORTC:
state=(((PORTC) & (1<<(pin))) >> (pin));
break;
case GPIO_PORTD:
state=(((PORTD) & (1<<(pin))) >> (pin));
break;
case GPIO_PORTE:
state=(((PORTE) & (1<<(pin))) >> (pin));
break;
default:
break;
}
...
{
case GPIO_PORTA:
(PORTA = (((PORTA)&(~(mask))) | ((state)&(mask))));
break;
case GPIO_PORTB:
(PORTB = (((PORTB)&(~(mask))) | ((state)&(mask))));
break;
case GPIO_PORTC:
(PORTC = (((PORTC)&(~(mask))) | ((state)&(mask))));
break;
case GPIO_PORTD:
(PORTD = (((PORTD)&(~(mask))) | ((state)&(mask))));
break;
case GPIO_PORTE:
(PORTE = (((PORTE)&(~(mask))) | ((state)&(mask))));
break;
default:
break;
}
...
{
case GPIO_PORTA:
(PORTA = (((PORTA)&(~(1<<(pin)))) | ((state)<<(pin))));
break;
case GPIO_PORTB:
(PORTB = (((PORTB)&(~(1<<(pin)))) | ((state)<<(pin))));
break;
case GPIO_PORTC:
(PORTC = (((PORTC)&(~(1<<(pin)))) | ((state)<<(pin))));
break;
case GPIO_PORTD:
(PORTD = (((PORTD)&(~(1<<(pin)))) | ((state)<<(pin))));
break;
case GPIO_PORTE:
