...
void Motor_Init(tMotor_TargetAngle initial_target_angle)
{
GPIO_InitPin(GPIO_PORTC,GPIO_PIN0,GPIO_OUTPUT_DIR);

GPIO_SetPinState(GPIO_PORTC,GPIO_PIN0,GPIO_LOW);
...
GPIO_SetPinState(GPIO_PORTC,GPIO_PIN0,GPIO_HIGH);
