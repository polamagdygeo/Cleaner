...
void SSD_Init(tSSD ssd,tSSD_Symbol intial_symbol)
{
GPIO_InitPort(GPIO_PORTD,0x7f,GPIO_OUTPUT_DIR);
GPIO_InitPin(GPIO_PORTD,GPIO_PIN7,GPIO_OUTPUT_DIR);

switch(ssd)
{
case SSD_LEFT:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN6,GPIO_OUTPUT_DIR);
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN6,GPIO_LOW);
break;
case SSD_CENTER:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN5,GPIO_OUTPUT_DIR);
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN5,GPIO_LOW);
break;
case SSD_RIGHT:
GPIO_InitPin(GPIO_PORTB,GPIO_PIN4,GPIO_OUTPUT_DIR);
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN4,GPIO_LOW);
break;
default:
break;
}
...
{
case SSD_LEFT:
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN6,state);
break;
case SSD_CENTER:
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN5,state);
break;
case SSD_RIGHT:
GPIO_SetPinState(GPIO_PORTB,GPIO_PIN4,state);
break;
default:
...
GPIO_SetPortState(GPIO_PORTD,0x7f,Symbol_Code_Array[Current_Symbol]);
